...
setup(name='cbtools',
      ...
      packages=['cbtools', 'cbtools.config', 'cbtools.core', 'cbtools.manager', 'cbtools.manager.api', 'cbtools.manager.queue', 'cbtools.rename', 'cbtools.tag', 'cbtools.tag.extensions'],
